/* toplev.c -- changed for emx by Eberhard Mattes -- Jan 1992 */
     ...
     char *name;
{
  ...
  if (rtl_dump)
    {
      ...
      strcat (dumpname, ".rtl");
      rtl_dump_file = fopen (dumpname, "wt");
      if (rtl_dump_file == 0)
  ...
  if (jump_opt_dump)
    {
      ...
      strcpy (dumpname, dump_base_name);
      strcat (dumpname, ".jp");
      jump_opt_dump_file = fopen (dumpname, "wt");
  ...
  if (cse_dump)
    {
      ...
      strcpy (dumpname, dump_base_name);
      strcat (dumpname, ".cse");
      cse_dump_file = fopen (dumpname, "wt");
      if (cse_dump_file == 0)
	pfatal_with_name (dumpname);
    }
  ...
  if (loop_dump)
    {
      ...
      loop_dump_file = fopen (dumpname, "wt");
      if (loop_dump_file == 0)
	pfatal_with_name (dumpname);
    }
  ...
  if (flow_dump)
    {
      ...
      flow_dump_file = fopen (dumpname, "wt");
      if (flow_dump_file == 0)
	pfatal_with_name (dumpname);
    }
  ...
  if (combine_dump)
    {
      ...
      strcpy (dumpname, dump_base_name);
      strcat (dumpname, ".cmb");
      combine_dump_file = fopen (dumpname, "wt");
  ...
  if (local_reg_dump)
    {
      ...
      local_reg_dump_file = fopen (dumpname, "wt");
  ...
  if (global_reg_dump)
    {
      ...
      global_reg_dump_file = fopen (dumpname, "wt");
  ...
  if (jump2_opt_dump)
    {
      ...
      strcpy (dumpname, dump_base_name);
      strcat (dumpname, ".jp2");
      jump2_opt_dump_file = fopen (dumpname, "wt");
  ...
  if (dbr_sched_dump)
    {
      ...
      strcpy (dumpname, dump_base_name);
      strcat (dumpname, ".dbr");
      dbr_sched_dump_file = fopen (dumpname, "wt");
  ...
  if (! name_specified && asm_file_name == 0)
	...
	asm_out_file = fopen (asm_file_name, "wt");
      if (asm_out_file == 0)
